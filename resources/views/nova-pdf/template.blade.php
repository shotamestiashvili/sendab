...
<body class="tailwind-container">
    @foreach ($models->customers as $model)
...
<!--                    <label class="font-semibold text-xl">Resource Name :</label>-->
                    <p class="font-semibold text-blue-600 text-xl"> Document  : {{ $resource::label() }} </p>
                </div>
...
<!--                    <p class="font-semibold text-blue-600 text-xl"> {{ $model->id }} </p>-->
                    <p class="font-semibold text-blue-600 text-xl">Firstname:  {{ $model->id}} </p>
<!--                    <p class="font-semibold text-blue-600 text-xl">Lastname:  {{ $model->customers->lastname }} </p>-->
